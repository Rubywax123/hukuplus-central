...
import { Store, FileSignature, MapPin, CheckCircle, Clock } from "lucide-react";
  ...
  return (
    <div className="pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        <StatCard delay={0.1} title="Total Retailers" value={stats?.totalRetailers || 0} icon={Store} colorClass="text-blue-400 bg-blue-400" />
        <StatCard delay={0.2} title="Active Branches" value={stats?.totalBranches || 0} icon={MapPin} colorClass="text-purple-400 bg-purple-400" />
        <StatCard delay={0.3} title="Pending Signatures" value={stats?.pendingSignatures || 0} icon={Clock} colorClass="text-amber-400 bg-amber-400" />
        <StatCard delay={0.4} title="Signed Today" value={stats?.signedToday || 0} icon={CheckCircle} colorClass="text-emerald-400 bg-emerald-400" />
      </div>
